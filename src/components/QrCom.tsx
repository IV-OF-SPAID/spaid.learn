...
const QrCom = () => {
  return (
    <div className="w-full flex flex-col px-4 md:px-20 pt-5 gap-5 ">
      <div className="w-full max-w-[880px] h-auto md:h-[170px] bg-[#DDEDF3] rounded-xl p-4 flex flex-col md:flex-row items-center mx-auto">
        ...
        <div className="h-full px-0 md:px-5 py-3 w-full md:w-100 flex flex-col items-center md:items-start">
          <h1 className="text-lg text-center text-[#013F5E] md:text-left">
