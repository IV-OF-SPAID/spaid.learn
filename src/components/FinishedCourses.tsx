          ...
          <ul className="flex flex-col gap-2">
            {displayedCourses.map((course) => (
              <li
                ...
                className="flex justify-between items-center h-17 py-2 border-l-4 border-[#ff9801] bg-white rounded-lg shadow-sm pl-3 cursor-pointer hover:shadow-md transition-shadow"
